from context import FileTripBuilder, Optimizer, BatteryRewardOnlyEnvironment, NissanLeaf, Optimizer, Visualize
...
environment = BatteryRewardOnlyEnvironment(trip)
